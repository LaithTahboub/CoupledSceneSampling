...
from seva.modules.preprocessor import Dust3rPipeline, get_pose_pipeline  # noqa: E402
...
def main():
    ...
    # --- Pose estimation preprocessing (same as SEVA pipeline) ---
    print(f"Running {args.pose_estimator}...")
    pose_pipeline = get_pose_pipeline(args.pose_estimator, device=device)
    input_imgs, input_Ks, input_c2ws, (W, H) = preprocess_advanced(img_paths, pose_pipeline)
